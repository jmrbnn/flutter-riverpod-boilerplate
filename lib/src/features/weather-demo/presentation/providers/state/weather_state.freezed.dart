...
class _$FailedImpl implements Failed {
  ...
  @override
  String toString() {
    return 'WeatherState.failed(failure: $failure)';
  }
...
abstract class Failed implements WeatherState {
  const factory Failed({required final AppException? failure}) = _$FailedImpl;
